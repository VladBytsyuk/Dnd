...
import io.vbytsyuk.dnd.domain.background.Background.Statement
import io.vbytsyuk.dnd.domain.equipment.Equipment
import io.vbytsyuk.dnd.domain.equipment.Item
...
import io.vbytsyuk.dnd.domain.units.LawVsChaos.CHAOTIC
...
data class Acolyte(
    ...
    override val suggestedCharacteristics = Background.SuggestedCharacteristics(
        ...
        ideals = listOf(
            Statement("Tradition. The ancient traditions of worship and sacrifice must be preserved and upheld.", LAWFUL),
            Statement("Charity. I always try to help those in need, no matter what the personal cost.", GOOD),
            Statement("Change. We must help bring about the changes the gods are constantly working in the world.", CHAOTIC),
            Statement("Power. I hope to one day rise to the top of my faith's religious hierarchy.", LAWFUL),
            Statement("Faith. I trust that my deity will guide my actions, I have faith that if I work hard, things will go well.", LAWFUL),
